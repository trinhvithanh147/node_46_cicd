...
(1, 'em an com chua', 8, 7, '2025-04-01 07:21:48', '2025-04-01 07:21:48');
INSERT INTO `chats` (`chat_id`, `message`, `user_id_sender`, `user_id_recipient`, `created_at`, `updated_at`) VALUES
(2, 'hello', 7, 8, '2025-04-01 07:21:58', '2025-04-01 07:21:58');
INSERT INTO `chats` (`chat_id`, `message`, `user_id_sender`, `user_id_recipient`, `created_at`, `updated_at`) VALUES
(3, 'ds', 7, 8, '2025-04-01 07:31:51', '2025-04-01 07:31:51');
INSERT INTO `chats` (`chat_id`, `message`, `user_id_sender`, `user_id_recipient`, `created_at`, `updated_at`) VALUES
(4, 'dsa', 7, 8, '2025-04-01 07:31:52', '2025-04-01 07:31:52'),
(5, 'dasdas', 8, 7, '2025-04-01 07:31:53', '2025-04-01 07:31:53');

INSERT INTO `permissions` (`permission_id`, `name`, `endpoint`, `method`, `module`, `created_at`, `updated_at`) VALUES
(1, 'READ_VIDEO', '/video/video-list', 'GET', 'videos', '2025-02-08 17:56:29', '2025-02-08 17:56:29');
INSERT INTO `permissions` (`permission_id`, `name`, `endpoint`, `method`, `module`, `created_at`, `updated_at`) VALUES
(2, 'CREATE VIDEO', '/video/video-create', 'GET', 'videos', '2025-02-08 17:56:29', '2025-02-08 17:56:29');


INSERT INTO `role_permissions` (`role_permissions_id`, `role_id`, `permission_id`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 2, 1, 1, '2025-02-08 18:00:13', '2025-02-16 20:32:52');
INSERT INTO `role_permissions` (`role_permissions_id`, `role_id`, `permission_id`, `is_active`, `created_at`, `updated_at`) VALUES
(2, 2, 2, 1, '2025-02-08 18:08:08', '2025-02-16 17:36:10');
INSERT INTO `role_permissions` (`role_permissions_id`, `role_id`, `permission_id`, `is_active`, `created_at`, `updated_at`) VALUES
(3, 1, 1, 0, '2025-02-16 18:38:15', '2025-02-16 18:38:15');

INSERT INTO `roles` (`role_id`, `name`, `description`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'ROLE_ADMIN', 'Quản trị (ông trùm)', 1, '2025-02-08 17:50:16', '2025-02-08 17:50:16');
INSERT INTO `roles` (`role_id`, `name`, `description`, `is_active`, `created_at`, `updated_at`) VALUES
(2, 'ROLE_USER', 'Người dùng hệ thống', 1, '2025-02-08 17:51:06', '2025-02-08 17:51:06');
...
INSERT INTO `users` (`user_id`, `email`, `pass_word`, `full_name`, `avatar`, `goole_id`, `face_app_id`, `created_at`, `updated_at`, `role_id`) VALUES
(2, 'trinhvithanh4@gmail.com', '$2b$10$fZrqwf48xphKOMGOeXGtpeKn5pGRfry2pSqfnxuWkx96vY6Qv81GC', 'vithanh1', 'https://res.cloudinary.com/duepu8vku/image/upload/v1743709051/images/anq7wd3jnhdqialxxf5c.jpg', NULL, NULL, '2025-01-18 10:42:00', '2025-04-03 19:37:31', 2);
INSERT INTO `users` (`user_id`, `email`, `pass_word`, `full_name`, `avatar`, `goole_id`, `face_app_id`, `created_at`, `updated_at`, `role_id`) VALUES
(4, 'trinhvithanh9433@gmail.com', '$2b$10$MnlzxACPE9K3IYDdlh1lXecrcPsitRamEqjj8VTi1YvfEm12Cry.2', 'thanh1', NULL, NULL, NULL, '2025-02-16 19:31:50', '2025-02-16 19:31:50', 2);
INSERT INTO `users` (`user_id`, `email`, `pass_word`, `full_name`, `avatar`, `goole_id`, `face_app_id`, `created_at`, `updated_at`, `role_id`) VALUES
(6, 'nguyentitest@gmail.com', '$2b$10$pYV9KN2gvO5opXgQ6lmAC.oyA31gjbeljixlU7jY12jR1vqjTqeUy', 'nguyenthitest', NULL, NULL, NULL, '2025-03-07 18:05:58', '2025-03-07 18:05:58', 2),
(7, 'trinhvithanh1@gmail.com', '$2b$10$ExqLxRqzjYrW1H5.W2cdwuNgQH1dLK82QMlMPmCLrlNDkF4a42b12', 'thanh1', NULL, NULL, NULL, '2025-03-31 18:42:33', '2025-03-31 18:42:33', 2),
(8, 'trinhvithanh2@gmail.com', '$2b$10$1.a2fSwt6INMOEdB7e4S9.4uTHUHrI8qvUzj0/DY35WImofIA0Iwm', 'thanh2', NULL, NULL, NULL, '2025-03-31 18:42:42', '2025-03-31 18:42:42', 2),
(9, 'thanhvitrinh@gmail.com', '$2b$10$yb4D1BU8a8lQrBpgNLTsL.zxPLRCnUbGMEmy/krXTMaW4otWbNodK', 'thanhvi', 'https://res.cloudinary.com/duepu8vku/image/upload/v1743709126/images/tbi0wppyz5wsvsfrb2ep.webp', NULL, NULL, '2025-04-03 18:38:00', '2025-04-03 19:38:46', 2);
...
(10, 'hello_typeName', NULL, '2025-04-11 07:28:48', '2025-04-11 07:28:48'),
(11, 'hello_typeName', NULL, '2025-04-11 07:44:36', '2025-04-11 07:44:36');

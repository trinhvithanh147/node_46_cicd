...
describe("Auth Service", () => {
  ...
  afterEach(() => {
    ...
    jest.restoreAllMocks(); // những dữ liệu giả định mà mình tạo ra và mình muốn làm mới
  });
  it("Case 1: Trường hợp đăng ký thành công với thông tin hợp lệ", async () => {
    ...
    await prisma.users.create.mockResolvedValue({
      user_id: 5,
      email: "nguyentitest@gmail.com",
      full_name: "nguyenthitest",
      avatar: null,
      goole_id: null,
      face_app_id: null,
      created_at: "2025-03-07T18:03:54.000Z",
      updated_at: "2025-03-07T18:03:54.000Z",
      role_id: 2,
    });
    const req = {
      body: {
